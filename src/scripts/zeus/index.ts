...
post?: [{	id:number},ValueTypes["Post"]],
		__typename?: true
}>;
	["Mutation"]: AliasType<{
createPost?: [{	createPostInput:ValueTypes["CreatePostInput"]},ValueTypes["Post"]],
updatePost?: [{	updatePostInput:ValueTypes["UpdatePostInput"]},ValueTypes["Post"]],
removePost?: [{	id:number},ValueTypes["Post"]],
		__typename?: true
}>;
	["CreatePostInput"]: {
	/** Post Title */
